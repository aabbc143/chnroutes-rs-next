...
pub fn classify_bgp_network(evidence: &BgpAsnEvidence) -> BgpNetworkType {
    ...
    if class.contains("eyeball") || class.contains("isp") || class.contains("access") {
...
mod tests {
    ...
    #[test]
    fn test_cn_isp() {
        let result = classify_bgp_network(&evidence("CN", "Eyeball"));
    ...
    #[test]
    fn test_cn_hosting() {
        let result = classify_bgp_network(&evidence("CN", "Hosting"));
    ...
    #[test]
    fn test_hk() {
        let result = classify_bgp_network(&evidence("HK", "Eyeball"));
    ...
    #[test]
    fn test_overseas() {
        let result = classify_bgp_network(&evidence("US", "Hosting"));
    ...
    #[test]
    fn test_unknown() {
        let result = classify_bgp_network(&evidence("CN", "Unknown"));
